    ...
    <>
      ...
      <Card className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm font-medium text-ivory">Vesting progress</span>
          <span className="text-xs text-taupe">{pctUnlocked}% unlocked at TGE</span>
        </div>
        <div className="h-3 rounded-full bg-obsidian/60 overflow-hidden mb-3">
          <div className="h-full rounded-full bg-gold-gradient" style={{ width: `${pctUnlocked}%` }} />
        </div>
      ...
      <Card>
        <div className="flex items-start gap-3">
          ...
          <div>
            <div className="text-sm font-medium text-ivory mb-1">Subject to final terms</div>
            <p className="text-sm text-ash leading-relaxed">{allocation.vesting_note}</p>
